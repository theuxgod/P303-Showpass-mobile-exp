...
<template>
  <div class="details-page">
    <header class="topbar">
      ...
      <span class="topbar-mark">NLF</span>
    </header>
    ...
    <footer class="details-footer"><button class="primary-button" @click="$router.push('/')"><v-icon icon="mdi-ticket-confirmation-outline" /> View pass</button></footer>
  </div>
</template>